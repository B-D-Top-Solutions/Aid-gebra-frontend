    ...
    methods : {
        async loadUser () {
            try{
                ...
                .get(
                    import.meta.env.VITE_SERVER+
                    import.meta.env.VITE_API_STUDENT_USER+"/"+res.data.id
                )
        ...
        async changePassword () {
            try{
                ...
                .put(
                    import.meta.env.VITE_SERVER+
                    import.meta.env.VITE_API_STUDENT_CHANGEPASSWORD,
                    {
        ...
        async updateUser () {
            try{
                ...
                .put(
                    import.meta.env.VITE_SERVER+
                    import.meta.env.VITE_API_STUDENT_PROFILEUPDATE,
                    {
        ...
        async changeImage () {
            try{
                ...
                .put(
                    import.meta.env.VITE_SERVER+
                    import.meta.env.VITE_API_STUDENT_PROFILEIMAGE,
                    form
                )
